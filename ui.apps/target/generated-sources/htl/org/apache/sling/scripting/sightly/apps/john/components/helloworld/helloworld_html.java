 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.john.components.helloworld;
...
out.write("\n    ");
_global_model = renderContext.call("use", com.adobe.aem.guides.john.core.models.HelloWorldModel.class.getName(), obj());
{
    ...
    if (renderContext.getObjectModel().toBoolean(var_testvariable2)) {
        out.write("<div class=\"cmp-helloworld__item\">\n        <p class=\"cmp-helloworld__item-label\">Model message:</p>\n        <div class=\"cmp-helloworld__item-output\" data-cmp-hook-helloworld=\"model\">");
        {
            Object var_3 = renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_global_model, "message"), "html");
